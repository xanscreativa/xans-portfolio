...
export default function FeaturedWorks() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#FFFDFC] py-14 sm:py-20 lg:py-32">
      ...
      <div className="relative mx-auto w-[92%] max-w-7xl">
        ...
        {/* FEATURED CARD */}
        <FadeUp delay={0.15}>
          <div className="group relative overflow-hidden rounded-[24px] border border-pink-100/80 bg-white p-4 shadow-[0_20px_50px_rgba(0,0,0,0.04)] sm:rounded-[32px] sm:p-6 lg:rounded-[36px] lg:p-8">
            <div className="grid items-center gap-6 sm:gap-8 lg:grid-cols-12 lg:gap-12">
              {/* LEFT: Image Showcase */}
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[20px] bg-[#F9F4F2] sm:rounded-[24px] lg:col-span-6 lg:aspect-[4/3] xl:col-span-7">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
                ...
                <div className="absolute left-3 top-3 rounded-full border border-white/40 bg-white/80 px-3 py-1 text-[11px] font-bold tracking-wider text-[#2D2433] backdrop-blur-md sm:left-4 sm:top-4 sm:px-4 sm:py-1.5 sm:text-xs">
                  {project.client}
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center lg:col-span-6 xl:col-span-5">
                ...
                <h3 className="mt-1.5 text-2xl font-black tracking-tight text-[#2D2433] sm:mt-2 sm:text-4xl">
                  {project.title}
                </h3>
