...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute left-0 top-24 h-72 w-72 sm:h-96 sm:w-96 rounded-full bg-pink-100 blur-[100px] sm:blur-[120px]"
        style={{ transform: `translateY(${bgOffset}px)` }}
      />
      <div className="pointer-events-none absolute right-10 sm:right-20 top-20 h-[350px] w-[350px] sm:h-[500px] sm:w-[500px] rounded-full bg-pink-200/30 blur-[100px] sm:blur-[120px]" />
      <div className="pointer-events-none absolute -z-20 right-0 top-0 h-[500px] w-[500px] sm:h-[700px] sm:w-[700px] rounded-full bg-[radial-gradient(circle_at_center,#FAD9E7_0%,transparent_70%)] opacity-70 blur-2xl" />
      ...
      <div className="relative z-10 mx-auto grid w-[92%] max-w-7xl items-center gap-10 lg:grid-cols-12 lg:gap-8">
        ...
        <div className="lg:col-span-7 text-center sm:text-left">
          ...
          <FadeUp delay={0.08}>
            <p className="mt-5 sm:mt-6 text-[11px] sm:text-xs font-bold uppercase tracking-[0.35em] sm:tracking-[0.45em] text-pink-500">
              ALEXANDRA
            </p>
          </FadeUp>

          <FadeUp delay={0.16}>
            <h1 className="mt-2.5 sm:mt-3 text-3xl font-black leading-[1.12] tracking-tight text-[#2D2433] sm:text-5xl lg:text-6xl xl:text-[4.25rem]">
              Graphic Designer <br className="hidden sm:block" />
              <span className="text-pink-500">&amp;</span> Video Editor
            </h1>
          </FadeUp>
          ...
          <FadeUp delay={0.24}>
            <p className="mt-4 sm:mt-6 mx-auto max-w-xl text-sm leading-6 text-[#6B6570] sm:mx-0 sm:text-lg sm:leading-8">
          ...
          <FadeUp delay={0.32}>
            <div className="mt-5 sm:mt-6 flex flex-wrap justify-center gap-2 sm:gap-2.5 sm:justify-start">
          ...
          <FadeUp delay={0.4}>
            <div className="mt-7 sm:mt-8 flex flex-col items-stretch sm:items-center justify-center gap-3 sm:flex-row sm:justify-start">
              <Button href="#portfolio">View Portfolio</Button>
          ...
          {/* Clean Stats Grid */}
          <FadeUp delay={0.48}>
            <div className="mt-10 sm:mt-12 grid grid-cols-2 gap-x-4 gap-y-6 border-t border-pink-100/80 pt-6 sm:pt-8 sm:grid-cols-4 sm:gap-4">
              {[
                {
                  n: 50,
                  l: "Projects",
                ...
                <div key={s.l} className="flex flex-col items-center sm:items-start text-center sm:text-left">
                  <div className="mb-2 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-pink-50 text-pink-500">
                    {s.icon}
                  </div>
                  <h3 className="text-2xl sm:text-3xl font-black text-[#2D2433] lg:text-4xl">
                    <Counter end={s.n} suffix="+" />
                  </h3>
                  <p className="mt-1 whitespace-pre-line text-[11px] sm:text-xs font-semibold uppercase tracking-wider text-[#6B6570]">
                    {s.l}
                  </p>
                </div>
              ))}
        ...
        <div className="relative mt-8 lg:col-span-5 lg:mt-0">
          <div className="relative mx-auto max-w-sm sm:max-w-md lg:max-w-none">
            ...
            <div className="pointer-events-none absolute left-1/2 top-1/2 -z-20 h-[300px] w-[300px] sm:h-[400px] sm:w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-tr from-pink-300/40 via-pink-200/30 to-transparent blur-[50px] sm:blur-[70px]" />

            {/* Brush Image */}
            <FadeUp delay={0.64}>
              <div className="pointer-events-none absolute -right-4 -top-8 sm:-right-6 sm:-top-10 -z-10 w-[100%] max-w-[520px] select-none opacity-20 blur-[2px]">
                <Image
                  src="/hero/brush.png"
                  alt=""
                  width={900}
            ...
            {/* Flowers Layer */}
            <FadeUp delay={0.6}>
              <div className="pointer-events-none absolute -right-6 -top-10 sm:-right-8 sm:-top-12 -z-10 w-[105%] max-w-[550px] select-none">
                <motion.div
                  animate={{ rotate: [-0.8, 0.8, -0.8] }}
                  transition={{
                    duration: 16,
            ...
            <FadeUp delay={0.72}>
              <motion.div
                ...
                className="absolute bottom-2 left-1/2 -translate-x-1/2 sm:bottom-6 sm:left-auto sm:right-0 sm:translate-x-0 z-20 w-[230px] sm:w-[280px] max-w-[calc(100%-1rem)] rounded-2xl border border-white/80 bg-white/85 p-3.5 sm:p-4 shadow-[0_15px_30px_rgba(0,0,0,0.06)] backdrop-blur-md"
              >
                <p className="text-xs sm:text-sm font-medium leading-snug text-[#6B6570]">
