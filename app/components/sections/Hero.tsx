    ...
    <>
      ...
      <header
        className={`fixed left-0 right-0 top-0 z-50 transition-all duration-300 ${
          scrolled
            ? "border-b border-pink-100/60 bg-white/80 py-3 shadow-[0_4px_20px_rgba(229,135,176,0.05)] backdrop-blur-md"
            : "bg-transparent py-5"
        }`}
      >
        <div className="mx-auto flex w-[92%] max-w-7xl items-center justify-between">
          ...
          <div className="hidden md:block">
            <Link
              href="#contact"
              className="inline-flex items-center justify-center rounded-full bg-pink-500 px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white shadow-[0_10px_20px_rgba(236,72,153,0.25)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-pink-600 hover:shadow-[0_12px_25px_rgba(236,72,153,0.35)]"
            >
              Connect
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="absolute left-0 right-0 top-full border-b border-pink-100 bg-white/95 p-6 shadow-xl backdrop-blur-xl md:hidden">
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="#contact"
                onClick={() => setMobileMenuOpen(false)}
                className="mt-2 rounded-full bg-pink-500 py-3 text-center text-xs font-bold uppercase tracking-wider text-white"
              >
                Connect
              </Link>
            </div>
