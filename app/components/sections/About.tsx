...
=======
      className="relative overflow-hidden bg-[#FFFDFC] py-12 sm:py-20 lg:py-32"
    >
      {/* Background Glow */}
...
=======
              <div className="overflow-hidden rounded-[28px] bg-[#F9F4F2] p-2 shadow-[0_25px_60px_rgba(0,0,0,.06)] xs:rounded-[36px] sm:rounded-[42px] sm:p-3">
>>>>>>> 213c202 (feat: complete mobile responsive optimization for all sections)
                <Image
...
=======
                  className="h-auto w-full rounded-[22px] object-cover xs:rounded-[30px] sm:rounded-[34px]"
>>>>>>> 213c202 (feat: complete mobile responsive optimization for all sections)
                  priority
                />
              </div>
...
=======
              <div className="absolute -right-1 bottom-4 rounded-xl border border-white/80 bg-white/90 p-3.5 shadow-xl backdrop-blur-md xs:-right-2 xs:bottom-6 xs:rounded-2xl xs:p-5 sm:-right-6 sm:bottom-10 sm:rounded-[28px] sm:px-7 sm:py-6">
                <p className="text-[9px] font-bold uppercase tracking-[0.25em] text-pink-500 xs:text-[10px] sm:text-xs sm:tracking-[0.35em]">
                  EXPERIENCE
                </p>
                <h3 className="mt-0.5 text-2xl font-black text-[#2D2433] xs:text-3xl sm:mt-2 sm:text-5xl">
                  4+
                </h3>
                <p className="mt-0.5 text-[11px] font-medium leading-tight text-[#6B6570] xs:text-xs sm:mt-1 sm:text-sm sm:leading-normal">
>>>>>>> 213c202 (feat: complete mobile responsive optimization for all sections)
